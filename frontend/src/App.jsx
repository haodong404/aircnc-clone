    ...
    <h1 class="text-cyan-700">
      ...
      {/* <Router>
        ...
        <Routes>
          <Route
            path="/"
            element={<Landing user={user} dispatch={dispatch} />}
          ></Route>
          <Route path="/login" element={<Login />}></Route>
          <Route
            path="/register"
            element={<Register dispatch={dispatch} />}
          ></Route>
          <Route path="/book" element={<BookProp />}></Route>
          <Route path="/addListing" element={<AddProperty />}></Route>
